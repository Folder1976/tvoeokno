...
--
-- Database: `alegar_oknoop`
--

-- --------------------------------------------------------

--
-- Table structure for table `fash_attribute`
--

CREATE TABLE IF NOT EXISTS `fash_attribute` (
  `attribute_id` int(11) NOT NULL AUTO_INCREMENT,
  `attribute_group_id` int(11) NOT NULL,
  `filter_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `index` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
  `enable` int(11) NOT NULL,
  `attribute_type` int(11) NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `fash_attribute`
--

INSERT INTO `fash_attribute` (`attribute_id`, `attribute_group_id`, `filter_name`, `index`, `sort_order`, `enable`, `attribute_type`) VALUES
(1, 1, '', 2, 1, 1, 1),
(2, 1, '', 17, 16, 1, 1),
(3, 1, '', 9, 8, 1, 1),
(4, 1, '', 3, 2, 1, 1),
...
(96, 5, '', 0, 12, 1, 1),
(98, 5, '', 0, 14, 1, 1),
(99, 1, '33333333', 20, 43, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `fash_attribute_description`
--

CREATE TABLE IF NOT EXISTS `fash_attribute_description` (
...
--
-- Dumping data for table `fash_attribute_description`
--

INSERT INTO `fash_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Чорний'),
(2, 1, 'Оранжевий'),
(3, 1, 'Синій'),
(4, 1, 'Білиц'),
...
(97, 1, 'Камінчики'),
(56, 1, 'Буденний'),
(57, 1, 'Парадно-Вихідні'),
(81, 1, 'Відкритий пальчик'),
(82, 1, 'Закритий пальчик'),
(83, 1, 'Гострий Носик'),
(84, 1, 'Груглий ніс'),
(65, 1, 'Шпилька-Висока'),
(66, 1, 'Грубий-Високий'),
(67, 1, 'Шпилька-Середня'),
(68, 1, 'Грубий-Середній'),
(69, 1, 'Широкий-Низький'),
(70, 1, 'Широки-Середній'),
(71, 1, 'Вчительський'),
(72, 1, 'Шпилька-Тонка'),
(73, 1, 'Шпилька-Товста'),
(74, 1, 'Шпилька-Широка'),
(75, 1, 'Класична-Танкетка'),
(76, 1, 'Середня-Танкетка'),
(77, 1, 'Висока-Танкетка'),
(78, 1, 'Танкетка-Тракторна'),
(86, 1, 'Тракторна підошва'),
(87, 1, 'Резинка на підйомі'),
(88, 1, 'Замок збоку'),
(89, 1, 'Шнурівка'),
(90, 1, 'Два замки '),
(91, 1, 'Без замка'),
(92, 1, 'Спортивна танкетка'),
(93, 1, 'Снікерси'),
(94, 1, 'Груба підошва'),
(95, 1, 'Ліпучка'),
(96, 1, '2-ві Резинки побоках'),
(98, 1, 'Брошка'),
(99, 1, '111111');
...
--
-- Table structure for table `fash_attribute_group`
--

CREATE TABLE IF NOT EXISTS `fash_attribute_group` (
...
--
-- Dumping data for table `fash_attribute_group`
--

INSERT INTO `fash_attribute_group` (`attribute_group_id`, `sort_order`, `enable`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(4, 4, 1),
...
--
-- Table structure for table `fash_attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `fash_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fash_attribute_group_description`
--

INSERT INTO `fash_attribute_group_description` (`attribute_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Цвет', ''),
(2, 1, 'Материал', ''),
(3, 1, 'Сезон', ''),
(4, 1, 'Стиль', ''),
...
CREATE TABLE IF NOT EXISTS `oc_attribute` (
  ...
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
  `filter_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
INSERT INTO `oc_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`, `filter_name`, `enable`, `index`) VALUES
(1, 6, 1, '', 0, 1),
(2, 6, 5, '', 0, 1),
(3, 6, 3, '', 0, 1),
(4, 3, 1, '', 0, 1),
...
CREATE TABLE IF NOT EXISTS `oc_attribute2` (
  `attribute_id` int(11) NOT NULL AUTO_INCREMENT,
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oc_attribute3` (
  `attribute_id` int(11) NOT NULL AUTO_INCREMENT,
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
  `href` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oc_attribute4` (
  `attribute4_id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL,
  `enable` int(1) NOT NULL DEFAULT '1',
  `price` int(11) NOT NULL,
  PRIMARY KEY (`attribute4_id`)
...
CREATE TABLE IF NOT EXISTS `oc_attribute_description2` (
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
  PRIMARY KEY (`attribute_id`,`language_id`)
...
CREATE TABLE IF NOT EXISTS `oc_attribute_description3` (
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
  PRIMARY KEY (`attribute_id`,`language_id`)
...
CREATE TABLE IF NOT EXISTS `oc_attribute_description4` (
  `attribute4_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` varchar(64) NOT NULL,
  PRIMARY KEY (`attribute4_id`,`language_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `oc_attribute_group` (`attribute_group_id`, `sort_order`, `href`, `enable`) VALUES
(3, 2, '', 1),
(4, 1, '', 1),
(5, 3, '', 1),
(6, 4, '', 1);
...
CREATE TABLE IF NOT EXISTS `oc_attribute_group2` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  `href` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `enable` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `oc_attribute_group3` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  `href` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `enable` int(1) NOT NULL DEFAULT '1',
...
INSERT INTO `oc_attribute_group_description` (`attribute_group_id`, `language_id`, `name`, `description`) VALUES
(3, 1, 'Память', ''),
(4, 1, 'Technical', ''),
...
CREATE TABLE IF NOT EXISTS `oc_attribute_group_description2` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oc_attribute_group_description3` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
(16, 1, 5, 0, 1, 'John', '2017-11-29 23:19:23', 'catalog/demo/information/4-848x424.png'),
(17, 1, 7, 0, 1, 'John', '2017-11-29 23:20:06', 'catalog/demo/information/5-848x424.png'),
(18, 1, 1, 0, 1, 'John', '2017-11-30 01:34:53', ''),
(19, 1, 11, 0, 1, 'John', '2017-11-30 01:35:39', ''),
(20, 1, 0, 0, 1, 'John', '2017-12-02 16:11:42', ''),
(21, 1, 0, 0, 1, 'John', '2017-12-02 16:12:20', ''),
(22, 1, 0, 0, 1, 'John', '2017-12-02 16:12:44', '');
...
(54, 1, 'Новости', '', '', '', ''),
(54, 2, 'Новости', '', '', '', ''),
(55, 1, 'Стандартные статьи', '', '', '', ''),
(55, 2, 'Стандартные статьи', '', '', '', '');
...
(18, 2, 'Пластиковые окна на выбор', '', '', '', '', '', ''),
(18, 1, 'Пластиковые окна на выбор', '', '', '', '', '', ''),
(19, 2, 'Пластиковые окна на выбор2', '', '', '', '', '', ''),
(19, 1, 'Пластиковые окна на выбор2', '', '', '', '', '', ''),
(20, 1, 'О компании', '', '', '', '', '', ''),
(20, 2, 'О компании', '', '', '', '', '', ''),
(21, 1, 'Доставка', '', '', '', '', '', ''),
(21, 2, 'Доставка', '', '', '', '', '', ''),
...
CREATE TABLE IF NOT EXISTS `oc_blog_related_products` (
  `blog_id` int(11) NOT NULL,
...
(85, 3, 'banner.30', 'column_left', 1),
(84, 3, 'category', 'column_left', 0),
(92, 1, 'html.33', 'content_top', 0);
...
(30, 'Товар 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, 100.0000, 0, 9, '2009-02-03', 0.00, 1, 0.00, 0.00, 0.00, 1, 1, 1, 0, 1, 0, '2009-02-03 16:59:00', '2018-01-08 23:01:07'),
...
(49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'catalog/demo/samsung_tab_1.jpg', 0, 1, 199.9900, 0, 9, '2011-04-25', 0.00, 1, 0.00, 0.00, 0.00, 1, 1, 1, 1, 1, 2, '2011-04-26 08:57:34', '2011-09-30 01:06:23');
...
(2369, 30, 'catalog/demo/canon_eos_5d_2.jpg', 0),
...
(2368, 30, 'catalog/demo/canon_eos_5d_3.jpg', 0),
...
(30, '123123', 435435, 44333, 7787),
(30, 'xcfvgxzc', 4344, 555, 777),
(30, 'Open teck', 16881, 20002, 6);
...
(978, 0, 'config', 'config_address', '', 0),
(977, 0, 'config', 'config_owner', 'Мое Имя', 0),
(976, 0, 'config', 'config_name', 'Мой Магазин', 0),
(975, 0, 'config', 'config_meta_keyword', '', 0),
(974, 0, 'config', 'config_meta_description', 'Мой Магазин', 0),
(973, 0, 'config', 'config_meta_title', 'Мой Магазин', 0),
(972, 0, 'config', 'config_sms_gate_password', '', 0),
(968, 0, 'config', 'config_sms_to', '', 0),
(969, 0, 'config', 'config_sms_copy', '', 0),
(970, 0, 'config', 'config_sms_message', '', 0),
(971, 0, 'config', 'config_sms_gate_username', '', 0),
(960, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(961, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(4, 0, 'voucher', 'voucher_sort_order', '8', 0),
(5, 0, 'voucher', 'voucher_status', '1', 0),
(952, 0, 'config', 'config_compression', '0', 0),
(953, 0, 'config', 'config_mail_regexp', '/^[^@]+@.*.[a-z]{2,15}$/i', 0),
(954, 0, 'config', 'config_editor_default', '0', 0),
(955, 0, 'config', 'config_secure', '0', 0),
(956, 0, 'config', 'config_password', '1', 0),
(957, 0, 'config', 'config_shared', '0', 0),
...
(967, 0, 'config', 'config_sms_from', '', 0),
(966, 0, 'config', 'config_sms_gatename', 'testsms', 0),
(965, 0, 'config', 'config_sms_alert', '0', 0),
(964, 0, 'config', 'config_error_filename', 'error.log', 0),
(963, 0, 'config', 'config_error_log', '1', 0),
(962, 0, 'config', 'config_error_display', '1', 0),
(951, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
...
(400, 0, 'account', 'account_status', '1', 0),
...
(949, 0, 'config', 'config_seo_url_postfix', '', 0),
(950, 0, 'config', 'config_seo_pro_utm', 'block\r\nfrommarket\r\ngclid\r\nkeyword\r\nlist_type\r\nopenstat\r\nopenstat_service\r\nopenstat_campaign\r\nopenstat_ad\r\nopenstat_source\r\nposition\r\nsource\r\ntracking\r\ntype\r\nyclid\r\nymclid\r\nuri\r\nurltype\r\nutm_source\r\nutm_medium\r\nutm_campaign\r\nutm_term\r\nutm_content', 0),
(948, 0, 'config', 'config_seo_url_include_path', '1', 0),
(946, 0, 'config', 'config_seo_url', '1', 0),
(947, 0, 'config', 'config_seo_url_type', 'seo_url', 0),
(943, 0, 'config', 'config_mail_alert', '["order"]', 1),
(945, 0, 'config', 'config_maintenance', '0', 0),
(944, 0, 'config', 'config_alert_email', '', 0),
...
(934, 0, 'config', 'config_ftp_root', '', 0),
(935, 0, 'config', 'config_ftp_status', '1', 0),
(936, 0, 'config', 'config_mail_protocol', 'mail', 0),
(933, 0, 'config', 'config_ftp_password', '123456a', 0),
(929, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(930, 0, 'config', 'config_ftp_hostname', 'alegar.ftp.tools', 0),
(931, 0, 'config', 'config_ftp_port', '21', 0),
(932, 0, 'config', 'config_ftp_username', 'alegar_tvoeokno', 0),
(928, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
...
(923, 0, 'config', 'config_affiliate_id', '4', 0),
(921, 0, 'config', 'config_affiliate_auto', '0', 0),
(922, 0, 'config', 'config_affiliate_commission', '5', 0),
(920, 0, 'config', 'config_affiliate_approval', '0', 0),
(919, 0, 'config', 'config_stock_checkout', '0', 0),
(918, 0, 'config', 'config_stock_warning', '0', 0),
(917, 0, 'config', 'config_stock_display', '0', 0),
(916, 0, 'config', 'config_api_id', '1', 0),
(915, 0, 'config', 'config_fraud_status_id', '2', 0),
(914, 0, 'config', 'config_complete_status', '["3","5"]', 1),
(912, 0, 'config', 'config_order_status_id', '1', 0),
(913, 0, 'config', 'config_processing_status', '["2","3","1","12","5"]', 1),
(911, 0, 'config', 'config_checkout_id', '5', 0),
(910, 0, 'config', 'config_checkout_guest', '1', 0),
(908, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(909, 0, 'config', 'config_cart_weight', '1', 0),
(907, 0, 'config', 'config_account_id', '3', 0),
(906, 0, 'config', 'config_login_attempts', '5', 0),
(905, 0, 'config', 'config_customer_price', '0', 0),
(904, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(903, 0, 'config', 'config_customer_group_id', '1', 0),
(902, 0, 'config', 'config_customer_search', '0', 0),
(901, 0, 'config', 'config_customer_activity', '0', 0),
...
(897, 0, 'config', 'config_tax', '1', 0),
(896, 0, 'config', 'config_voucher_max', '1000', 0),
(895, 0, 'config', 'config_voucher_min', '1', 0),
(894, 0, 'config', 'config_review_guest', '1', 0),
...
(893, 0, 'config', 'config_review_status', '1', 0),
(892, 0, 'config', 'config_product_mpn_hide', '0', 0),
(891, 0, 'config', 'config_product_isbn_hide', '0', 0),
(890, 0, 'config', 'config_product_jan_hide', '0', 0),
(889, 0, 'config', 'config_product_ean_hide', '0', 0),
(888, 0, 'config', 'config_product_upc_hide', '0', 0),
(887, 0, 'config', 'config_limit_admin', '20', 0),
(886, 0, 'config', 'config_product_count', '0', 0),
(885, 0, 'config', 'config_weight_class_id', '1', 0),
(884, 0, 'config', 'config_length_class_id', '1', 0),
(883, 0, 'config', 'config_currency_auto', '0', 0),
(882, 0, 'config', 'config_currency', 'UAN', 0),
(881, 0, 'config', 'config_admin_language', 'ru-ru', 0),
(880, 0, 'config', 'config_language', 'ru-ru', 0),
(879, 0, 'config', 'config_zone_id', '2785', 0),
(877, 0, 'config', 'config_image', '', 0),
(878, 0, 'config', 'config_country_id', '176', 0),
(871, 0, 'config', 'config_theme', 'theme_default', 0),
(872, 0, 'config', 'config_layout_id', '4', 0),
(873, 0, 'config', 'config_geocode', '54.718681,20.499113', 0),
(874, 0, 'config', 'config_email', 'folder.list@gmail.com', 0),
(875, 0, 'config', 'config_telephone', '123456789', 0),
(876, 0, 'config', 'config_fax', '', 0),
(870, 0, 'config', 'config_langdata', '{"1":{"meta_title":"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d","meta_description":"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d","meta_keyword":"","name":"\\u041c\\u043e\\u0439 \\u041c\\u0430\\u0433\\u0430\\u0437\\u0438\\u043d","owner":"\\u041c\\u043e\\u0435 \\u0418\\u043c\\u044f","address":"\\u0410\\u0434\\u0440\\u0435\\u0441","open":"\\u0441 10\\u0447 \\u0434\\u043e 18\\u0447\\r\\n\\u043e\\u0431\\u0435\\u0434 \\u0441 14\\u0447 \\u0434\\u043e 15\\u0447\\r\\n\\u0432\\u043e\\u0441\\u043a\\u0440\\u0435\\u0441\\u0435\\u043d\\u044c\\u0435 - \\u0432\\u044b\\u0445\\u043e\\u0434\\u043d\\u043e\\u0439","comment":""},"2":{"meta_title":"Your Store","meta_description":"My Store","meta_keyword":"","name":"Your Store","owner":"Your Name","address":"Address 1","open":"","comment":""}}', 1);
...
CREATE TABLE IF NOT EXISTS `oc_url_alias` (
  ...
  UNIQUE KEY `language_id` (`language_id`,`keyword`)
...
(638, 'common/home', 1, ''),
(824, 'product_id=48', 1, 'ipod-classic'),
(836, 'category_id=20', 1, 'desktops'),
(834, 'category_id=26', 1, 'pc'),
(835, 'category_id=27', 1, 'mac'),
(730, 'manufacturer_id=8', 1, 'apple'),
(768, 'product_id=42', 1, 'test'),
(789, 'category_id=34', 1, 'mp3-players'),
(781, 'category_id=36', 1, 'test2'),
(774, 'category_id=18', 1, 'laptop-notebook'),
(775, 'category_id=46', 1, 'macs'),
(776, 'category_id=45', 1, 'windows'),
(777, 'category_id=25', 1, 'component'),
(778, 'category_id=29', 1, 'mouse'),
(779, 'category_id=28', 1, 'monitor'),
(780, 'category_id=35', 1, 'test1'),
(782, 'category_id=30', 1, 'printer'),
(783, 'category_id=31', 1, 'scanner'),
(784, 'category_id=32', 1, 'web-camera'),
(785, 'category_id=57', 1, 'tablet'),
(786, 'category_id=17', 1, 'software'),
(787, 'category_id=24', 1, 'smartphone'),
(788, 'category_id=33', 1, 'camera'),
(790, 'category_id=43', 1, 'test11'),
(791, 'category_id=44', 1, 'test12'),
(792, 'category_id=47', 1, 'test15'),
(793, 'category_id=48', 1, 'test16'),
(794, 'category_id=49', 1, 'test17'),
(795, 'category_id=50', 1, 'test18'),
(796, 'category_id=51', 1, 'test19'),
(797, 'category_id=52', 1, 'test20'),
(798, 'category_id=58', 1, 'test25'),
(799, 'category_id=53', 1, 'test21'),
(800, 'category_id=54', 1, 'test22'),
(801, 'category_id=55', 1, 'test23'),
(802, 'category_id=56', 1, 'test24'),
(803, 'category_id=38', 1, 'test4'),
(804, 'category_id=37', 1, 'test5'),
(805, 'category_id=39', 1, 'test6'),
(806, 'category_id=40', 1, 'test7'),
(807, 'category_id=41', 1, 'test8'),
(808, 'category_id=42', 1, 'test9'),
(866, 'product_id=30', 1, 'canon-eos-5d'),
(840, 'product_id=47', 1, 'hp-lp3065'),
(811, 'product_id=28', 1, 'htc-touch-hd'),
(812, 'product_id=43', 1, 'macbook'),
(813, 'product_id=44', 1, 'macbook-air'),
(814, 'product_id=45', 1, 'macbook-pro'),
(816, 'product_id=31', 1, 'nikon-d300'),
(817, 'product_id=29', 1, 'palm-treo-pro'),
(818, 'product_id=35', 1, 'product-8'),
(819, 'product_id=49', 1, 'samsung-galaxy-tab-10-1'),
(820, 'product_id=33', 1, 'samsung-syncmaster-941bw'),
(821, 'product_id=46', 1, 'sony-vaio'),
(837, 'product_id=41', 1, 'imac'),
(823, 'product_id=40', 1, 'iphone'),
(825, 'product_id=36', 1, 'ipod-nano'),
(826, 'product_id=34', 1, 'ipod-shuffle'),
(827, 'product_id=32', 1, 'ipod-touch'),
(828, 'manufacturer_id=9', 1, 'canon'),
(829, 'manufacturer_id=5', 1, 'htc'),
(830, 'manufacturer_id=7', 1, 'hewlett-packard'),
(831, 'manufacturer_id=6', 1, 'palm'),
(832, 'manufacturer_id=10', 1, 'sony'),
(842, 'information_id=3', 1, 'privacy'),
(843, 'information_id=5', 1, 'terms'),
(844, 'blog_category_id=50', 1, 'action'),
(845, 'blog_category_id=54', 1, 'news'),
(846, 'blog_category_id=51', 1, 'work_time'),
(847, 'blog_category_id=49', 1, 'НАШИ_ПРЕИМУЩЕСТВА'),
(848, 'blog_category_id=53', 1, 'НАШИ_УСЛУГИ'),
(849, 'blog_category_id=52', 1, 'garanty'),
(850, 'blog_id=17', 1, 'warranty_service'),
(855, 'blog_id=16', 1, 'Best_price'),
(852, 'blog_id=19', 1, 'plastic_windows_to_choose_from2'),
(853, 'blog_id=18', 1, 'plastic_windows_to_choose_from'),
(854, 'blog/home', 1, 'blogs'),
(856, 'blog_category_id=55', 1, 'information'),
(857, 'blog_id=20', 1, 'about_us'),
(858, 'blog_id=21', 1, 'delivery'),
(859, 'blog_id=22', 1, 'oplava');
...
(1, 1, 'admin', '6a5246a3fd475c395a5afe73f4c5e38153560bc1', 'XZWgb3Bqh', 'John', 'Doe', 'folder.list@gmail.com', '', '', '127.0.0.1', 1, '2017-11-30 13:05:50');
