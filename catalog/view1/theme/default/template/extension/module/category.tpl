                ...
                <?php } ?>
                    ...
                    <?php if ($child['children']) { ?>
                        <?php foreach ($child['children'] as $child1) { ?>
                          <?php if ($child1['category_id'] == $child_id) { ?>
                              <li><a href="<?php echo $child1['href']; ?>" class="active">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <?php echo $child1['name']; ?></a></li>
                          <?php } else { ?>
                              <li><a href="<?php echo $child1['href']; ?>" class="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <?php echo $child1['name']; ?></a></li>
                          <?php } ?>
                        <?php } ?>
                    <?php } ?>
