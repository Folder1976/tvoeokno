<?php
// Heading
$_['heading_title'] = 'Оформлення заявки';

// Text
$_['text_cart'] = 'Кошик для покупок';
$_['text_checkout_option'] = 'Крок %s: Спосіб оформлення заявки';
...
$_['text_shipping_method'] = 'Оберіть зручний спосіб доставки для даного заявки';
$_['text_payment_method'] = 'Виберіть спосіб оплати для даного заявки';
$_['text_comments'] = 'Ви можете додати свій коментар до своїх заявок';
...
// Error
$_['error_warning'] = 'Виникла проблема при обробці Вашого заявки! Якщо проблема виникає знову, виберіть інший спосіб оплати або <a href="%s">зв&#39;яжіться з адміністратором магазину</a>.';
