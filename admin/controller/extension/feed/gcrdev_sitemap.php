...
class ControllerExtensionFeedGcrdevSitemap extends Controller {
	...
	public function generateSitemap() {
		...
		if($group=='products'){$this->model_extension_feed_gcrdev_sitemap->generateProducts();}
		elseif($group=='categories'){$this->model_extension_feed_gcrdev_sitemap->generateCategories();}
		elseif($group=='brands'){$this->model_extension_feed_gcrdev_sitemap->generateBrands();}
		elseif($group=='pages'){$this->model_extension_feed_gcrdev_sitemap->generatePages();}
		elseif($group=='information'){$this->model_extension_feed_gcrdev_sitemap->generateInformation();}
	...
	public function restoreSitemap() {
		...
		$this->load->language('extension/feed/gcrdev_sitemap');
		$this->load->model('extension/feed/gcrdev_sitemap');
		$this->model_extension_feed_gcrdev_sitemap->restoreSitemap($group);
		$button_restore_title=$this->language->get('button_restore_title');
		$button_restore=$this->language->get('button_restore');
		...
		if($this->model_extension_feed_gcrdev_sitemap->restoreSitemap($group)==true){
	...
	public function deleteSitemap() {
		...
		$this->load->language('extension/feed/gcrdev_sitemap');
		$this->load->model('extension/feed/gcrdev_sitemap');
		$this->model_extension_feed_gcrdev_sitemap->deleteSitemap($group);
		$button_restore_title=$this->language->get('button_restore_title');
		$button_restore=$this->language->get('button_restore');
		$text_generate=$this->language->get('text_generate');
		$text_sitemap_gen=$this->language->get('text_sitemap_gen');
	...
	public function updateDisabled() {
		...
		$this->load->language('extension/feed/gcrdev_sitemap');
		$this->load->model('extension/feed/gcrdev_sitemap');
		$this->model_extension_feed_gcrdev_sitemap->updateIncStatus($group);
	...
	public function updateSettings() {
		...
		$change=$_POST['change'];
		$this->load->model('extension/feed/gcrdev_sitemap');
		$this->model_extension_feed_gcrdev_sitemap->updateSet($table,$group,$change);
	}
	...
	public function updateFootTxt() {
		$post=str_replace('\\r\\n', '', $_POST['footTxt']);
		$this->load->model('extension/feed/gcrdev_sitemap');
		$this->model_extension_feed_gcrdev_sitemap->updateFooter($post);
	}
	...
	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
		...
		$data['prodCheck']=$this->model_extension_feed_gcrdev_sitemap->getSet('products');
		$data['catCheck']=$this->model_extension_feed_gcrdev_sitemap->getSet('categories');
		$data['infoCheck']=$this->model_extension_feed_gcrdev_sitemap->getSet('information');
		$data['footerText']=$this->model_extension_feed_gcrdev_sitemap->getFoot();
		$data['sitemaps']=array();
