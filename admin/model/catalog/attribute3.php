...
class ModelCatalogAttribute3 extends Model {
	public function addAttribute($data) {
		...
		foreach ($data['attribute_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description3
	...
	public function editAttribute($attribute_id, $data) {
		...
		foreach ($data['attribute_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description3 SET attribute_id = '" . (int)$attribute_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "'");
		}
	}
	...
	public function getAttribute($attribute_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "attribute3 a
								  LEFT JOIN " . DB_PREFIX . "attribute_description3 ad ON (a.attribute_id = ad.attribute_id)
