<?php
class ModelCatalogAttributeGroup3 extends Model {
	public function addAttributeGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group3 SET href = '" . $data['href'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editAttributeGroup($attribute_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "attribute_group3 SET
	...
	public function getAttributeGroup($attribute_group_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "attribute_group3 WHERE attribute_group_id = '" . (int)$attribute_group_id . "'");
	...
	public function getTotalAttributeGroups() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "attribute_group3");
