...
class ModelCatalogAttributeGroup2 extends Model {
	public function addAttributeGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group2 SET href = '" . $data['href'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editAttributeGroup($attribute_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "attribute_group2 SET
	...
	public function deleteAttributeGroup($attribute_group_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "attribute_group2 WHERE attribute_group_id = '" . (int)$attribute_group_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "attribute_group_description2 WHERE attribute_group_id = '" . (int)$attribute_group_id . "'");
	}
