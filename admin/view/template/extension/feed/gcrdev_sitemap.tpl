...
print '</ul></div></div>';
echo $warning;
ModelExtensionFeedGcrdevSitemap::alert('success',$products_sitemap_generated,'products','alert_products');
ModelExtensionFeedGcrdevSitemap::alert('success',$categories_sitemap_generated,'categories','alert_categories');
ModelExtensionFeedGcrdevSitemap::alert('success',$brands_sitemap_generated,'brands','alert_brands');
ModelExtensionFeedGcrdevSitemap::alert('success',$page_sitemap_generated,'pages','alert_pages');
ModelExtensionFeedGcrdevSitemap::alert('success',$info_sitemap_generated,'information','alert_information');
ModelExtensionFeedGcrdevSitemap::alert('success','Success! settings have been updated','','disalert');
ModelExtensionFeedGcrdevSitemap::alert('success','Success! robots.txt file has been updated','','robalert');
ModelExtensionFeedGcrdevSitemap::alert('success','Success! footer text has been updated','','footalert');
...
function deleteSitemap(id,btn,btnrplc) {
	...
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/deleteSitemap&group='+id+'&token=<?php echo $token;?>',
		data: {group: id},
...
function updateSitemap(action,id,btn,btnrplc) {
	...
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/'+action+'Sitemap&group='+id+'&token=<?php echo $token;?>',
		success: (function (result) {
			$("#Update"+id).html(result);
			document.getElementById('alert_products').style.display= 'none' ;
			document.getElementById('alert_categories').style.display= 'none' ;
...
function updateDisabled(id) {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/updateDisabled&group='+id+'&token=<?php echo $token;?>',
		success: (function (result) {
...
function updateSelect(id,tbl) {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/updateSettings&table='+tbl+'&group='+id+'&token=<?php echo $token;?>',
...
function updateRobots() {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/updateRobots&token=<?php echo $token;?>',
...
function updateFootTxt() {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=extension/feed/gcrdev_sitemap/updateFootTxt&token=<?php echo $token;?>',
